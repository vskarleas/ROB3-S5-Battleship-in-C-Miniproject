...
echo -e "${GREEN}Bienvenue dans le jeu Battle Ship de Vasileios Filippos Skarleas et Yanis Sadoun. Une fois que vous êtes prêt à commencer à jouer, appuyez simplement sur ENTER"
